...
export function buildCodexPrompt(task: TaskSpec): string {
  return [
    `# ${task.title}`,
    '',
    'You are executing an AgenticKanbasutra task with Codex.',
    '',
    '## Task Metadata',
    '',
    ...
    '- Respect the configured sandbox and repository boundary.',
